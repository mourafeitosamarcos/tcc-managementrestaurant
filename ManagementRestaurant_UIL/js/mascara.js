...
function IsDate(sDate) {
    ...
    var dateRegExp = /^(19|20)\d\d-(0?[1-9]|1[012])-(0?[1-9]|3[01])$/;
    if (!dateRegExp.test(ano + "-" + mes + "-" + dia)) return false;
    if (dia == 31 && (/^0?[469]$/.test(mes) || mes == 11)) return false;
    else if (dia >= 30 && mes == 2) return false;
    else if (mes == 2 && dia == 29 && !(ano % 4 == 0 && !(ano % 100 != 0 || ano % 400 == 0))) return false;
    else return true;
}