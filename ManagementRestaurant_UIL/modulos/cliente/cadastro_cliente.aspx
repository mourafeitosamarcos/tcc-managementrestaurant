<%@ Page Title="" Language="C#" MasterPageFile="~/master/master.Master" AutoEventWireup="true" CodeBehind="cadastro_cliente.aspx.cs" Inherits="ManagementRestaurant_UIL.modulos.cliente.cadastro_cliente" %>
                            ...
                            <table class="auto-style2">
                                ...
                                <tr>
                                    <td colspan="7">
                                        ...
                                        <asp:Button ID="btnCancelar" runat="server" CssClass="Botoes" PostBackUrl="~/modulos/cliente/menu_cliente.aspx" Text="Cancelar" />
                                    </td>
                                </tr>
                            </table>
                        </asp:Panel>
