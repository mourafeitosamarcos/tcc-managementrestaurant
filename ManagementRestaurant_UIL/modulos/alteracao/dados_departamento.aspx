<%@ Page Language="C#" MasterPageFile="~/master/principal.Master" AutoEventWireup="true" CodeBehind="dados_departamento.aspx.cs" Inherits="ManagementRestaurant_UIL.modulos.alteracao.dados_departamento" %>
            ...
            <table class="auto-style2">
                <tr>
                    <td class="auto-style3" rowspan="7">
                        <asp:DropDownList Id="ddlDep" runat="server" OnLoad="ddlDep_Load" AutoPostBack="True" OnSelectedIndexChanged="ddlDep_SelectedIndexChanged">
                        </asp:DropDownList></td>
                    <td class="auto-style4" colspan="4"></td>
                </tr>
                </table>
            <asp:Panel ID="PnDep" runat="server" style="height: auto; margin-bottom: 2px; margin-right: 0px; width: auto;" Visible="False">
            <table>
                <tr>
                ...
                <tr>
                    <td class="auto-style5" colspan="4">
                        <asp:Button ID="btnConcluir" runat="server" CssClass="Aplicar" Text="    Aplicar" OnClick="btnConcluir_Click" />
