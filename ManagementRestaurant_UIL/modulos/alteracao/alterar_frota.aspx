<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/master/principal.Master"  CodeBehind="alterar_frota.aspx.cs" Inherits="ManagementRestaurant_UIL.modulos.alteracao.alterar_frota" %>
                            ...
                            <table class="auto-style2">
                                ...
                                <tr>
                                    <td colspan="6" class="auto-style3">
                                        &nbsp;<asp:Button ID="btnAlterar" runat="server" CssClass="Aplicar" OnClick="btnAlterar_Click" Text="    Alterar" />
                                        &nbsp;<asp:Button ID="btnConcluir" runat="server" CssClass="Aplicar" OnClick="btnConcluir_Click" Text="    Concluir" Visible="False" />
