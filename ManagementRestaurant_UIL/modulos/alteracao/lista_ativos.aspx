<%@ Page Language="C#" MasterPageFile="~/master/principal.Master" AutoEventWireup="true" CodeBehind="lista_ativos.aspx.cs" Inherits="ManagementRestaurant_UIL.modulos.alteracao.lista_ativos" %>
    ...
    <asp:Panel ID="Panel1" runat="server" style="height: auto; margin-bottom: 2px; margin-right: 0px; width: auto;">
        <fieldset id="fdsDadosPessoais">
            ...
            <table class="auto-style2">
                ...
                <tr>
                    <td colspan="5">
                        <asp:Panel ID="pGridPesquisa" runat="server" ScrollBars="Auto" Height="200px">
                            <asp:GridView ID="grdFuncionarios" runat="server" AutoGenerateColumns="False" OnRowCommand="grdFuncionarios_RowCommand" style="margin-top: 24px; text-align: center;" Width="1025px">
                                <Columns>
                                    ...
                                    <asp:ButtonField CommandName="Desabilitar" ButtonType="Image" HeaderText="Desabilitar Conta" ImageUrl="../../imgs/base/desabilitar.gif" />
                ...
                <tr>
                    <td colspan="5">
                        <asp:Button ID="btnInativos" runat="server" CssClass="Ativo" PostBackUrl="~/modulos/alteracao/lista_inativos.aspx" style="text-align: right" Text="    Inativos" />
