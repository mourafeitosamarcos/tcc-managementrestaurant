    ...
    public partial class lista_ativos : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    var _dt = (DataTable)Session["SalvaSearch"];

                    if (_dt != null)
                    {
                        CarregaGrid(_dt.Rows[0]["param"].ToString(), _dt.Rows[0]["coluna"].ToString());
                    }
                }
            }
        }
        ...
        protected void btnPesquisar_Click(object sender, EventArgs e)
        {
            ...
            _dt = (DataTable)Session["SalvaSearch"];
            if (_dt != null)
            {
                _dt.Clear();
            }
        ...
        private void CarregaGrid(string parametro, string coluna)
        {
            ...
            _conexaoMDL3 = _funcionarioBLL.PesquisaFuncionarios(parametro, coluna);
        ...
        protected void grdFuncionarios_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Desabilitar")
            {
                ...
                _conexaoMDL3 = _funcionarioBLL.DesabilitaFuncionario(_funcionarioMDL);
