...
{
    public partial class centro_custo : Page
    {
        ...
        protected void btnCadastrar_Click(object sender, EventArgs e)
        {
            if (ValidaCampos())
            {
                ...
                try
                {
                    _conexaoMDL = _financeiroBLL.CadastraCentroCusto(_financeiroMDL);
                }
                catch
                {
                    Page.ClientScript.RegisterClientScriptBlock(GetType(), "alertscript",
                ...
                Page.ClientScript.RegisterClientScriptBlock(GetType(), "alertscript",
                                                            _conexaoMDL.Validador == false
                                                                ...
                                                                : "<script>alert('Centro de custo já consta no sistema');</script>");
            }
        }
        ...
        {
            Response.Redirect("centro_custo.aspx");
        }
