<%@ Page Title="" Language="C#" MasterPageFile="~/master/master.Master" AutoEventWireup="true" CodeBehind="lista_ativos.aspx.cs" Inherits="ManagementRestaurant_UIL.modulos.administrativo.lista_ativos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel1" runat="server" style="height: auto; margin-bottom: 2px; margin-right: 0px; text-align: right; width: auto;">
        <fieldset id="fdsDadosPessoais">
            <legend style="font-family: Arial;" class="auto-style1">Pesquisa de Funcionarios Ativos</legend>
            <table class="auto-style2">
                        ...
                        <asp:Panel ID="pnCadastro" runat="server" Width="1054px">
                            <table class="auto-style2">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center">Pesquisar por:</td>
                ...
                <tr>
                    ...
                    <td class="auto-style5">
                        <asp:Button ID="btnInativos" runat="server" CssClass="Botoes" style="text-align: right" Text="Inativos" PostBackUrl="~/modulos/administrativo/lista_inativos.aspx" />
                        <asp:Button ID="btnLimpar" runat="server" CssClass="Botoes" Text="Limpar" PostBackUrl="~/modulos/administrativo/lista_ativos.aspx" />
                    </td>
                    <td class="auto-style5">&nbsp;</td>
                </tr>
            </table>
